...
Computational history is a particular kind of work one can do within the much larger domains of digital history or the digital humanities. For example, creating a content management system to manage historical sources is a kind of digital history but not computational history, but creating a visualization of the metadata in that content management system is computational history. What matters is not the specific action (computer programming) as the the kinds of sources and methods applied to them.
