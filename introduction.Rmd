...
- How this book is organized.
  - Part 1 is thinking. This takes you through several examples of using historical data to ask and answer historical questions. These chapters draw on techniques. But instead of explaining the techniques in depth, it demonstrates how to use them, and how they stand in relation to one another.
  - Part 2 is techniques. This shows how to do the techniques. These are more at the level of tutorials. But in the case of certain techniques like network analysis, there are suggestions about how to go further.
  - The appendices contain information that you might find useful, as well as advanced topics like increasing R’s performance.
  - How to use this book. I’d suggest reading through the examples. Then go in depth with the techniques.
