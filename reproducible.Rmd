...
dir.create("out")
ggsave("out/population-by-state.png", pop_plot, width = 8, height = 6)
```

Now we can run this script from the terminal without opening R. If you type the following at the terminal, it will run the analysis and create the plot `out/population-by-state.png`.
